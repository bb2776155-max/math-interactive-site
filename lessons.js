...
<p class='lesson-paragraph'>复习时不要只记住“这里要同乘 $x$”。你要问：为什么要同乘 $x$？仔细观察同乘 $x$ 带来了什么变化，就会发现，简单地说，同乘 $x$ 让这个式子变得更“好看”了。更自然的“好看”是：同乘以后出现了 $kx\\cdot2^{kx}$，它比原来的 $k\\cdot2^{kx}$ 明显更好看、更对称。因为 $kx=\\log_2 2^{kx}$，所以</p>
<p class='lesson-paragraph'>$$x\\log_2x-kx\\cdot2^{kx}=x\\log_2x-2^{kx}\\log_2 2^{kx},$$</p>
<p class='lesson-paragraph'>两边直接变成了同一种结构。</p>
