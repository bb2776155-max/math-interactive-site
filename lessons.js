...
<p class='lesson-paragraph'>复习时不要只记住“这里要同乘 $x$”。你要问：为什么要同乘 $x$？仔细观察同乘 $x$ 带来了什么变化，就会发现，简单地说，同乘 $x$ 让这个式子变得更“好看”了。更自然的“好看”是：同乘以后出现了 $kx\\cdot2^{kx}$，它比原来的 $k\\cdot2^{kx}$ 明显更好看、更对称。</p>
...
<p class='lesson-paragraph'>简单地说，自己给自己讲有三个作用：理清思路，确认自己是否真正懂了，让思维连续地向前运行。</p>
    ...
    {
        "id": "lesson-more-thinking-more-gained",
        "title": "多思多得，无思无得",
        "difficulty_tag": "知识",
        "stage_tag": "学习观",
        "mindset_tags": ["学习方法", "主动思考", "听讲", "看答案"],
        "steps": [
            {
                "question": "多思多得，无思无得",
                "answer": `<div class='thick-content no-auto-format'>
<p class='lesson-paragraph'>多思多得，无思无得。你在学习中能得到多少，很大程度上取决于你产生了多少自己的思考。</p>
<p class='lesson-paragraph'>很多学生听课时，只听到了老师所讲内容的字面意思，没有继续思考这些话的内涵，也没有关注这些内涵还能怎样扩展。结果就是，一开始似乎能听懂，听着听着突然听不懂了，甚至不知道自己从哪里开始没听懂。</p>
<p class='lesson-paragraph'>这是因为他没有跟上老师的思考，只是耳朵跟上了老师的嘴。这不是听讲，只是在听人说话。</p>
<p class='lesson-paragraph'>怎样知道自己听讲时有没有思考？一个很直接的表现，是你能不能产生属于自己的笔记。注意，笔记不能只是抄下老师讲的内容；那仍然只是在搬运字面意思。你应该及时记下自己的感想、疑问和联想。能产生这些东西，才说明老师的话进入了你的思维，并且在里面继续发生了反应。</p>
<p class='lesson-paragraph'>看答案也是一样。做不出一道题很正常，但是很多人不会看答案。他看答案，只是从头到尾验证答案的每一步都是正确的。验证完了，觉得自己看懂了，然后结束。</p>
<p class='lesson-paragraph'>这几乎没有意义。答案当然是对的，真正值得你思考的是：这个答案是如何想出来的？我为什么没有想出来？我具体是哪一个点没有想到？</p>
<p class='lesson-paragraph'>一定要把“我不会”继续拆下去。是没有观察到某个结构？没有想到尝试基本工具？不知道这个工具可以这样用？还是知道方向，却不会完成其中的变形？只有找到这个具体的点，你才知道自己需要补什么，这次不会的题才真正给你留下了收获。</p>
<p class='lesson-paragraph'>所以，有思考不是指学习时表情很认真，也不是指在一个地方停了很久。它必须留下痕迹：一个感想，一个疑问，一个联想，或者一个被你说清楚的“我具体为什么没想到”。</p>
<p class='lesson-paragraph'>没有这些东西，即使耳朵一直在听、眼睛一直在看、手一直在写，也可能没有多少获得。</p>
</div>`
            }
        ]
    },
