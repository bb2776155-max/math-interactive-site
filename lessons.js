        ...
        "steps": [
            {
                ...
                "answer": `<div class='thick-content no-auto-format'>
<p class='lesson-paragraph'>复习是最好的学习方式。复习中追求的是更好的理解：写出更好的笔记，把新产生的感想写在旁边。理解好了，再随手默写一下，会更扎实。注意，是理解好了之后默写，不是背。</p>
...
<p class='lesson-paragraph'>所以高中题的思路复推，很多时候其实就是这样：想一想，这个题是不是观察到什么，从而想到怎样；是不是想到尝试基本工具就行；是不是通过以什么为目标，就能推导出我们需要什么；或者一上来把题目条件进行翻译，把题目的目标进行翻译、转化，之后就方便处理了。</p>
<p class='lesson-paragraph'>这是一个很好的促进思维能力的办法，也是锻炼自己对基本工具、基本思路的理解和使用能力的办法。</p>
</div>`
            }
        ]
    },
...
<p class='lesson-paragraph'>事实上，小爱因斯坦应该自豪。能做出这么丑的小板凳，说明他可能手工天赋很差，而且从来没有接触过这种技能。可在这种情况下，他仍然独立地做出了对于自己的突破。</p>
<p class='lesson-paragraph'>你第一次讲一个题也可能讲得很差，但这没有什么可羞耻的。第一遍的小板凳越丑，能够暴露出来、等待你优化的东西就越多。只要第二遍比第一遍好，第三遍又比第二遍好，你就已经独立地完成了属于自己的突破。</p>
...
<p class='lesson-paragraph'>最好的理清自己思路的方法之一，就是把它讲出来。你一开口，就必须把脑中模糊的感觉变成一句接一句的话：我现在知道什么？我要解决什么？我为什么做这一步？接下来要往哪里走？</p>
<p class='lesson-paragraph'>这个过程能帮你抓持住自己的思路。你的思路不会散成许多模糊的碎片，而是像一条线一样，被语言牵着一点一点往前走。你能够一直知道自己正在想什么，也知道自己这样做是为了什么。</p>
<p class='lesson-paragraph'>出声学习也能确认自己到底懂没懂。只在脑中觉得“我懂了”，这个感觉可能是假的；真正给自己讲时，如果某个地方突然说不下去，只能含糊地说“反正就是这样”，那就说明这里还没有真正弄懂。</p>
<p class='lesson-paragraph'>卡壳并不是费曼学习法失败了。恰恰相反，卡壳就是它检查出来的结果。现在你终于知道自己的理解具体断在哪里，可以回去只修复这一处，然后再讲一遍。</p>
...
<p class='lesson-paragraph'>因此，写题卡住时，不要只是沉默地盯着题目。把你现在拥有的信息讲出来，把已经尝试过什么讲出来，把为什么卡住讲出来。你不一定会立刻得到答案，但至少能确认自己的思维仍然在运行，并且看清下一步可以继续处理什么。</p>
<p class='lesson-paragraph'>看知识和答案时也可以这样做。不要满足于耳朵跟上老师的嘴、眼睛跟上书上的字。停下来，离开材料，自己给自己讲一遍。能顺畅而清楚地讲出来，才说明这些内容已经开始进入你的思维；讲不出来，就回去弄清楚以后再讲。</p>
<p class='lesson-paragraph'>简单地说，自己给自己讲有三个作用：理清思路，确认自己是否真正懂了，保持思维连续地向前运行。</p>
</div>`
            }
        ]
    },
