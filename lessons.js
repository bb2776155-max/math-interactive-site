...
</div><div class='thin-content font-semibold text-indigo-300 mt-2'>【读薄】当目标不好下手时，先找更好用的条件；对干净的边长关系尝试正弦定理、余弦定理。某条路不好用就换路，得到可用结果后再回头和另一个条件对接。</div><div class='thin-content mt-3'><p class='lesson-paragraph font-semibold text-amber-300'>【回顾】这题里有一个很重要的变形感觉。</p><p class='lesson-paragraph'>首先是在观察法方面，在考虑余弦定理的时候，最好应该做到，看到</p>$$2a^2+c^2=2b^2$$<p class='lesson-paragraph'>时，心里能很快试代一下：如果换 $b^2$，它里面会冒出一个 $a^2$，而前边系数是 2，我去，这不就和左边的 $2a^2$ 消掉了吗？消消乐最爽了。</p><p class='lesson-paragraph'>我们再思考为什么对 $c^2$ 用余弦定理不好。我们本来面对的是 $2a^2+c^2=2b^2$，三个变量三个平方，给人很硬的感觉。把 $c^2$ 换掉以后，式子变成</p>$$3a^2-b^2-2ab\\cos C=0$$<p class='lesson-paragraph'>它依然是几个平方项和余弦项混在一起，结构还是很硬。当你想以 $b^2$ 为考虑的中心去化简时（比如用其他字母表示 $b$），你会发现 $a^2$ 在那里挡着；当你想以 $a^2$ 为考虑的中心去化简时，你会发现 $b^2$ 在那里挡着；防守坚硬、城墙坚固、无从下手。</p><p class='lesson-paragraph'>有了这种印象后，你就会觉得把 $b^2$ 换成含 $a^2$ 的式子后，是把一个稳定的结构拆掉一个角，让它失衡、往另一边倒，然后一下子就越来越好拆，越来越简单。它的复杂度下降了，不好处理的题目就开始松动了。</p><p class='lesson-paragraph'>所以你可以记住“消消乐”这个比喻。刚才解释是在说为什么消消乐会有用，并且希望你能心里有它，在做其他题的时候，也可以去想能不能消掉什么东西。当然，更基本的思维，即我们在这个题中使用的“找个好用条件然后直接用基本工具尝试”，是更重要的。</p><p class='lesson-paragraph'>从具体的题目来说，你也可以注意到，$a$ 和 $b$ 的系数都是 2，这也算是一个出题者设计的暗示。</p></div>`
            }
        ]
    },
    {
